...
class Forecast(nn.Module):
    def __init__(self, hidden_dim, forecast_hidden_dim=None, **model_args):
        ...
        self.output_seq_len = model_args['output_seq_len']
        self.forecast_fc    = nn.Linear(hidden_dim, forecast_hidden_dim)
        self.model_args     = model_args


    def forward(self, gated_history_data, hidden_states_dif, localized_st_conv, dynamic_graph):
        predict = []
        ...
        for _ in range(int(self.output_seq_len / self.model_args['gap'])-1):
            ...
            predict.append(localized_st_conv(_1, dynamic_graph))
